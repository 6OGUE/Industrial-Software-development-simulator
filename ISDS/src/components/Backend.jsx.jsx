...
export default function Backend() {
  ...
  const handleGenerateQuestion = async () => {
    setLoading(true);
    try {
      const prompt = `Assume I am a fresher who has just joined an IT company in a Backend developer role. I want to get familiar with the typical tasks and coding questions I am likely to face in this role at a multinational company (MNC). Please provide a sample coding question related to Backend development that a developer would commonly be assigned in an MNC, along with clear and detailed specifications that follow industry practices. The difficulty level should be ${difficulty}. Return only the question and specifications, without any explanations or answers. The question should be suitable for implementation in any programming language or frameworks, based on the user's preference.`;
    ...
    <div style={containerStyle}>
      ...
      <div style={contentWrapperStyle}>
        ...
        <div style={headerStyle}>
          <h1 style={titleStyle}>Backend Engineering</h1>
          <p style={{ fontSize: "1.1rem", color: "#e0e0e0", opacity: 0.85 }}>
            Build scalable server architecture and robust API systems
          </p>
        </div>
